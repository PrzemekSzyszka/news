...
class StoriesTest < ActiveSupport::TestCase
  ...
  def test_returns_all_stories_in_xml_format
    header 'Accept', 'application/xml; version=1'
  ...
  def test_returns_all_stories_in_format_with_higher_q
    header 'Accept', 'application/xml;q=0.4 application/json;q=0.8; version=1'
  ...
  def test_submitting_new_story_in_xml_format
    ...
    post '/stories', { title: 'Lorem epsum', url: 'http://www.lorem.com' }.to_xml,
                     { 'CONTENT_TYPE' => 'application/xml', 'HTTP_ACCEPT' => 'version=1' }
    assert_equal 201, last_response.status
  end
  ...
  def test_upvoting_a_story
    authorize @username, @password
    patch '/stories/1/vote', { delta: 1 }.to_json, { 'CONTENT_TYPE' => 'application/json', 'HTTP_ACCEPT' => 'version=1' }
  ...
  def test_second_upvoting_doesnt_affect_story
    authorize @username, @password
    patch "/stories/#{@story1.id}/vote", { delta: 1 }.to_json, { 'CONTENT_TYPE' => 'application/json', 'HTTP_ACCEPT' => 'version=1' }
    patch "/stories/#{@story1.id}/vote", { delta: 1 }.to_json, { 'CONTENT_TYPE' => 'application/json', 'HTTP_ACCEPT' => 'version=1' }
    header 'Accept', 'version=1'
    get "/stories/#{@story1.id}"
